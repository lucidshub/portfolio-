...
function __OriginkitBase_IsometricButton(props: IsometricButtonProps) {
    ...
    const live = useRef({
        floatRest, hoverFloat, glowBrightRest, glowBrightHover,
        reflOpacityRest, reflOpacityHover, textRGB, textHoverRGB, iconRGB, iconHoverRGB,
    })
    live.current = {
        floatRest, hoverFloat, glowBrightRest, glowBrightHover,
        reflOpacityRest, reflOpacityHover, textRGB, textHoverRGB, iconRGB, iconHoverRGB,
    ...
    useEffect(() => {
        ...
        floatRest, hoverFloat, thickness, glowBrightRest, glowBrightHover,
        reflOpacityRest, reflOpacityHover, textColor, hoverTextColor,
        iconColorProp, iconHoverColorProp,
    ])
            ...
            {hasIcon &&
                (iconMode === "image" ? (
                    <img
                        ...
                        draggable={false}
                        style={{
                            width: iconPx, height: iconPx, margin: iconPadPx,
                            objectFit: iconRadius > 0 ? "cover" : "contain",
                            borderRadius: Math.min(iconRadius, iconPx / 2),
                            display: "block", flex: "none", pointerEvents: "none",
                        }}
                    />
                ) : (
                    <span aria-hidden style={{
                        fontSize: iconPx, margin: iconPadPx, lineHeight: 1,
                        color: "var(--iso-icon)", flex: "none", pointerEvents: "none",
                    }}>
                        {iconSymbol}
                    </span>
                ))}
    ...
    const rowStyle: React.CSSProperties = {
        ...
        boxSizing: "border-box", padding, whiteSpace: "nowrap",
    ...
    return (
        ...
        >
            <div aria-hidden style={{ ...rowStyle, visibility: "hidden", pointerEvents: "none", ...fontStyles }}>
                {content()}
            </div>
            <div aria-hidden style={{
                ...
                <div style={{
                    ...faceStyle, background: glowGradient,
                ...
                <div style={{
                    position: "absolute", inset: 0, transformOrigin: "center bottom",
                    transform: "rotateX(var(--iso-stand))", transformStyle: "preserve-3d",
                }}>
                    <div style={{
                        ...faceStyle, background: glowGradient,
                    ...
                    {Array.from({ length: SIDE_LAYERS }, (_, i) => (
                        <div key={i} style={{
                            ...faceStyle, background: rgb(edgeRGB),
            ...
            <Hit
                ...
                onClick={onClick}
                style={{
                    position: "absolute", inset: HIT_INSET, border: 0,
                    background: "transparent", color: "transparent",
                    borderRadius: radius, cursor: "pointer", textDecoration: "none",
...
const __originkitPresetProps = {
    colors: { fill: "#16121D", textColor: "#FF5C5C", hoverTextColor: "#FFFFFF" },
    icon: { side: "left" as const, size: 24, type: "symbol" as const, color: "#A05CFF", image: "", symbol: "→", padding: 0, rounded: 0, hoverColor: "#FFFFFF" },
    prism: { color: "#A05CFF", float: 8, intensity: 100, thickness: 15, hoverFloat: 7 },
    camera: { tilt: 49, rotate: -37 },
    link: "",
    newTab: false,
